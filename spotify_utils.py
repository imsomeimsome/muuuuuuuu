...
def get_artist_name(artist_id):
    ...
    try:
        ...
        print(f"Error fetching artist name for {artist_id}: {str(e)}")
...
def get_artist_info(artist_id):
    ...
    try:
        ...
        print(f"Error fetching artist info for {artist_id}: {str(e)}")
        return None
...
def get_last_release_date(artist_id):
    ...
    try:
        ...
        print(f"Error fetching last release date for {artist_id}: {str(e)}")
        return "N/A"
...
def get_release_info(release_id):
    ...
    try:
        ...
        # Genres: merge album genres with all main artists' genres
        ...
        return {
            ...
            "genres": genres,
            "repost": False  # Spotify doesn't support reposts
        }
    except Exception as e:
...
def get_artist_discography(artist_id):
    ...
    try:
        ...
        print(f"Error fetching discography for {artist_id}: {str(e)}")
        return []
...
def search_artist(query):
    ...
    try:
        ...
        print(f"Error searching artist '{query}': {str(e)}")
        return []
